...
public:
    ...
    double similarityMeasure(const std::string& a, const std::string& b) const override;
};

double KNNString::similarityMeasure(const std::string &a, const std::string &b) const {
